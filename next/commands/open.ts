 ...
 */
export class OpenCommand extends AsyncSearchCommand<OrderSearchResult> {
  protected async performSearch(query: string): Promise<OrderSearchResult[]> {
    return OrdersAPI.searchOrders(query);
  }
